// 擴充主檔，完整功能實作版本
export default class ThreeDExtension {
  constructor(runtime) {
    ...
    return {
      ...
      blocks: [
        ...
        },
        {
          ...
          blockType: 'command',
          text: 'Set the scene camera to [TYPE]',
          arguments: {
            TYPE: {
              type: 'string',
              menu: 'cameraTypes',
        ...
        {
          opcode: 'setCameraAspect',
          blockType: 'command',
          text: 'Set camera aspect ratio to [ASPECT]',
          arguments: {
            ASPECT: { type: 'number', defaultValue: 1.5 }
          }
        },
        {
          opcode: 'createCube',
          ...
          arguments: {
            NAME: { type: 'string', defaultValue: 'Cube' },
            X: { type: 'number', defaultValue: 0 },
            Y: { type: 'number', defaultValue: 0 },
            Z: { type: 'number', defaultValue: 0 }
          }
  ...
  setCameraType(args) {
    const { PerspectiveCamera, OrthographicCamera } = this.THREE;
  ...
  setCameraRotation(args) {
    if (this.camera) {
      this.camera.rotation.set(args.X, args.Y, args.Z);
    }
  }
